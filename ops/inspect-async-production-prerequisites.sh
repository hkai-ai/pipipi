    ...
    case "$role" in
        api)
            allowed="BUSINESS_API_BASE_URL DATABASE_URL ASYNC_GATEWAY_SHARED_SECRET
                OPENAI_API_KEY OPENAI_BASE_URL OPENAI_API_MODE PI_PROVIDER PI_MODEL TEMPLATE_MODEL
                ...
                CRT_API_TIMEOUT_MS NEWS_IMAGE_API_TIMEOUT_MS PHOTO_POSTER_API_TIMEOUT_MS PROCESS_TIMEOUT_MS
                ...
                COMPOSED_TASK_ENABLED COMPOSED_TASK_MAX_STEPS COMPOSED_TASK_MAX_PRICED_STEPS
                COMPOSED_TASK_TIMEOUT_MS PI_COMPOSED_SKILL_DIRECTORY"
            ;;
        process-dispatcher)
        ...
        process-worker)
            allowed="BUSINESS_API_BASE_URL DATABASE_URL REDIS_URL OPENAI_API_KEY OPENAI_BASE_URL
                OPENAI_API_MODE PI_PROVIDER PI_MODEL TEMPLATE_MODEL PI_AGENT_DIR PI_SKILL_DIRECTORY
                ...
                NEWS_IMAGE_API_TIMEOUT_MS PHOTO_POSTER_API_TIMEOUT_MS PROCESS_TIMEOUT_MS PROCESS_RUN_LOG_LEVEL
