...
import type {
  ClaimedProcessOutboxMessage,
  ProcessOutbox,
} from "./process-outbox.js";
import { parseProcessWorkJob } from "./process-work-queue.js";
...
function claimedMessageFromRow(row: OutboxRow): ClaimedProcessOutboxMessage {
  ...
  if (!job) throw new Error("Persisted Process Work outbox payload is invalid");
  return {
