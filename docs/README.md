...
| 修改新闻图片风格流程 | [`api.md`](api.md) 与对应 [`processes/`](processes/) 目录 | [`src/processes/news-image/`](../src/processes/news-image)、[新闻图片 Runtime Skills](../.pi/skills) | [`test/news-image-process.test.ts`](../test/news-image-process.test.ts)、[`test/runtime-skills.test.ts`](../test/runtime-skills.test.ts) |
