...
| 修改 Agent Conversations | [`agent-conversations-design.md`](agent-conversations-design.md) 与 [`api.md`](api.md#agent-conversations首轮文本-tracer-bullet) | [`src/agent-conversations/`](../src/agent-conversations)、HTTP Adapter | [`test/agent-conversations-http.test.ts`](../test/agent-conversations-http.test.ts) |
