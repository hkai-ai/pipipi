...
| 修改 Agent Conversations | [`agent-conversations-design.md`](agent-conversations-design.md)、[`api.md`](api.md#agent-conversations多轮文本与图片资源) 与 [`agent-conversations-runbook.md`](agent-conversations-runbook.md) | [`src/agent-conversations/`](../src/agent-conversations)、[`src/agents/`](../src/agents)、对应 `src/app/` Composition Root | [`test/agent-conversations-http.test.ts`](../test/agent-conversations-http.test.ts)、[`test/production-agent-catalog.test.ts`](../test/production-agent-catalog.test.ts)、[`test/agent-resource-http.test.ts`](../test/agent-resource-http.test.ts)、[`test/postgres-agent-conversation-store.integration.test.ts`](../test/postgres-agent-conversation-store.integration.test.ts)、[`test/postgres-agent-tool-ledger.integration.test.ts`](../test/postgres-agent-tool-ledger.integration.test.ts)、[`test/bullmq-agent-turn-runtime.integration.test.ts`](../test/bullmq-agent-turn-runtime.integration.test.ts) |
