...
| 修改 Agent Conversations | [`agent-conversations-design.md`](agent-conversations-design.md) 与 [`api.md`](api.md#agent-conversations多轮文本与图片资源) | [`src/agent-conversations/`](../src/agent-conversations)、HTTP Adapter | [`test/agent-conversations-http.test.ts`](../test/agent-conversations-http.test.ts)、[`test/agent-conversations-multiturn-http.test.ts`](../test/agent-conversations-multiturn-http.test.ts)、[`test/agent-conversations-image-http.test.ts`](../test/agent-conversations-image-http.test.ts) |
