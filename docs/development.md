...
| `src/agent-conversations/` | Agent Registration/Registry、多轮 Conversation/Turn、owner-scoped 图片 Resource Resolver、Pi Interactive Agent、caller 操作级幂等、原子顺序、分页、Context Assembly、内存 Store、确定性 Queue、Worker 和读取时资源投影 |
